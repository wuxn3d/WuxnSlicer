...
Item
{
    ...
    Item
    {
        ...
        Button
        {
            ...
            onClicked:
            {
                if (Cura.MachineManager.activeMachine.name.slice(0, 4) == "Wuxn")
                {
                    menu1.opened ? menu1.close() : menu1.open()
                }
                else
                {
                    menu2.opened ? menu2.close() : menu2.open()
                }
            }
